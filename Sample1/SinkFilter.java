		...
		while (true)
		{
			try
			{
				...
				****************************************************************************/
				...
				if ( id == 5 )
				{
					//String erg_id5=TimeStampFormat.format(TimeStamp.getTime()) + " ID = " + id + " " + (Double.longBitsToDouble(measurement)/3.28084);
					//System.out.print(erg_id5);
					//writer.println(erg_id5);
				} // if
				if ( id == 3 )
				{
					...
					if ( erg_id3>=0){
						if (Math.abs(cash_Pressure-erg_id3)<=10){
						  System.out.print("Previous"+" " + cash_Pressure);
						  System.out.print( "\n" );
						  System.out.print(TimeStamp.getTime() + " ID = " + id + " " + erg_id3);
						  System.out.print( "\n" );
